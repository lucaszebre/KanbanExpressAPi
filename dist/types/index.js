...
export const UpdateColumnSchema = z.object({
    ...
    boardId: z.uuid("Invalid board ID format").optional(),
});
...
export const UpdateTaskBodySchema = z.object({
    ...
    columnId: z.uuid("Invalid column ID format").optional(),
});
...
export const UpdateSubtaskSchema = z.object({
    ...
    title: z.string().min(1, "Subtask title is required").optional(),
    isCompleted: z.boolean().optional(),
    taskId: z.uuid("Invalid task ID format").optional(),
});
...
export const PartialUpdateSubtaskSchema = UpdateSubtaskSchema.partial().required({ id: true });
// Login schema
