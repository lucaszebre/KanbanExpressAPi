...
var createNewUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var existingUser, user, _a, _b, token, error_1;
    var _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 1:
                ...
                if (existingUser) {
                    return [2 /*return*/, res.status(404).json({ error: 'Email already in use' })];
                }
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, auth_1.comparePasswords)(password, user.password)];
            case 2:
                isValid = _b.sent();
                if (!isValid) {
                    return [2 /*return*/, res.status(401).json({ message: "Invalid credentials" })];
